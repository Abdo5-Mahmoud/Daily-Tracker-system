...
### كيف يعمل المسار الآلي بمجرد إرسال صورة من الهاتف:
1. **المدخل (Input)**: يرسل عبده صورة خام ملتقطة بالموبايل لقطعة ديكور جديدة من المحل.
2. **المعالجة الذكية (Grounded Agent Processing)**:
   - يقرأ الوكيل جدول التصنيف أعلاه (Taxonomy) ليحدد تلقائياً هل القطعة كريستال، فازة، أم شجرة.
   - يحدد الوكيل "مكان التوظيف المنطقي" (رف شاشة، كونسول، أو ركن ميت) لمنع التوظيف غير الواقعي.
   - يصيغ برومبت فيديو سينمائي جاهز لمنصة Veo (حركة كاميرا دائرية بطيئة، إضاءة دافئة 2700K، وانعكاسات زجاجية واقعية).
   - يكتب هوك الفيديو بالعامية المصرية (مثل: "أكبر غلطة في فرش رف الشاشة...") مع كابشن السوشيال ميديا وسعر البيع ورابط الواتساب.
3. **الناتج الفوري (Instant Output)**:
   - برومبت فيديو Veo جاهز للنسخ.
   - كابشن تيك توك وفيسبوك ريلز جاهز للنشر في 10 ثوانٍ.
